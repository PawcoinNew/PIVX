...
// Copyright (c) 2015-2018 The PAWCOIN developers
...
#define QAPP_ORG_NAME "PAWCOIN"
#define QAPP_ORG_DOMAIN "pawcoin.org"
#define QAPP_APP_NAME_DEFAULT "PAWCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "PAWCOIN-Qt-testnet"
