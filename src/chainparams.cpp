...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x00000f1838268f77422ccd9bca16b99e826950b9ca163c02136c6cdd0136c09d"))
    (162145, uint256S("6de2650328d95dc6fe7bed31b4b5330c0e6b9f441bb4a6f6f05b5894e2a829a0")); //!< PIVX v4.1.1 enforced

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1582038716, // * UNIX timestamp of last checkpoint block
    324976,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        // spork keys
        consensus.strSporkPubKey = "0238a748d57cc19456182886f8c47ee8be3bafed3d650393819807033d45cb2052";
        consensus.strSporkPubKeyOld = "0";
        consensus.nTime_EnforceNewSporkKey = 1582038716;    //!> August 26, 2019 11:00:00 PM GMT
        consensus.nTime_RejectOldSporkKey = 0;     //!> September 26, 2019 11:00:00 PM GMT
        ...
        // validation by-pass
        consensus.nPivxBadBlockTime = std::numeric_limits<int>::max();    // Skip nBit validation of Block 259201 per PR #915
